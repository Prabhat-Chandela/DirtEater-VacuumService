...
import { Blinds, PanelRightClose, TvMinimal,Newspaper,SquareUser,SquareGanttChart } from 'lucide-react';
...
function Header() {
    ...
    return (
        <div className='w-full flex items-center justify-between p-3 bg-white shadow-md h-[15vh] fixed z-10'>
            ...
            <nav className="flex text-[#017BCC]">
                <div className="container mx-auto flex justify-between items-center">
                    ...
                    <div className={`bg-white absolute top-0 right-0 w-full h-screen mt-[15vh] lg:mt-0 lg:h-full flex flex-col items-center lg:static lg:flex-row lg:w-auto ${isOpen ? 'translate-x-0' : 'translate-x-full'} transition-all ease-in-out duration-200 lg:translate-x-0 `}>
